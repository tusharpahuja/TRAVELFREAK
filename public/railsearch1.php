	...
	<div class="layout_contact_us">
		...
		if (isset($_POST['submit']))
		{
			...
			{	
				...
				?> 
				<center>
					<p style="font: sans-serif; font-size: 40px; color: white;"> Search Result For Train : <?php echo $t;?> to <?php echo $dest;?> on <?php echo $dd;?> is  as follows.</p>
