...
<body>
	<div class="layout_contact_us" >
		<div>
			<h2 style="font-size: 60px;text-align: center; color: white; font-family: "Segoe UI Light","Segoe UI",Arial,Helvetica,sans-serif, cursive;">Take a Flight</h2>
		</div>
		<div class="travelpage-flight">
				<form method="post" style="color: white; text-align: center;" class="login" action="flightsearch1.php" name="myform">
					<div class="outer_box">
						<div class="from-to">
